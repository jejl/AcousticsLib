"""calltrackerslib.database.repositories — one module per table group."""
from .classifier_registry import ClassifierRegistryRepository
...
from .recorder_noise import RecorderNoiseRepository
from .sd_card import SDCardRepository
...
__all__ = [
    "CallLibraryRepository",
    "ClassifierRegistryRepository",
    "ClassifierTypeRepository",
    "DocsRepository",
