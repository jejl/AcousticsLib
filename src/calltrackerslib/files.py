...
Provides:
    file_sha256                 SHA-256 checksum of a single file
...
def file_sha256(path: Union[str, Path]) -> str:
    ...
    Reads in 8 KB chunks to keep memory use constant for large files.
    ...
    Raises:
        ...
        OSError: For other I/O errors (permissions, etc.).
...
def organize_by_date_recorder(
    ...
    :func:`calltrackerslib.audio.metadata.read_wav_metadata` to determine the
