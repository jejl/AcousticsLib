...
class Loader:
    ...
    Initialised from a header object (e.g. an :class:`~calltrackerslib.processing.hardware.AudioData`
    ...
    def load_time_series(
        ...
        try:
            ...
            for _ww in _w:
                if issubclass(_ww.category, WavFileWarning):
                    _log.debug("WAV warning %s: %s", self.filename, _ww.message)
